...
declare const stylexNoNonstandardStyles: {
  meta: {
    type: 'problem';
    hasSuggestions: true;
    fixable: 'code';
...
declare const $$EXPORT_DEFAULT_DECLARATION$$: typeof stylexNoNonstandardStyles;
